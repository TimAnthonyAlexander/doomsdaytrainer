...
import type { YearCodeTile } from './tiles';

interface YearCodeGridProps {
  tiles: YearCodeTile[];
}

/**
 * Four ways into the same hundred codes, as tiles.
 *
 ...
 */
export function YearCodeGrid({ tiles }: YearCodeGridProps) {
  return (
    <Box
      sx={{
        display: 'grid',
